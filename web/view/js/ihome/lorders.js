                ...
                $.ajax({
                    ...
                    success:function (resp) {
                        if ("4101" == resp.errno) {
                            ...
                            $(".orders-list>li[order-id="+ orderId +"]>div.order-content>div.order-text>ul li:eq(4)>span").html("已接單");
                ...
                $.ajax({
                    ...
                    success:function (resp) {
                        if ("4101" == resp.errno) {
                            ...
                            $(".orders-list>li[order-id="+ orderId +"]>div.order-content>div.order-text>ul li:eq(4)>span").html("已拒單");
                            $("ul.orders-list>li[order-id="+ orderId +"]>div.order-title>div.order-operate").hide();
